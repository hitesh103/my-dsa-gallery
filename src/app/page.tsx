    ...
    <main className="mx-auto flex w-full max-w-6xl flex-1 flex-col gap-10 px-4 py-14">
      <section className="flex flex-col gap-3">
        <div className="flex flex-col gap-2">
          ...
          <p className="max-w-2xl text-sm text-muted-foreground">
            A minimalist place to store my DSA notes: structured write-ups
            (problem → approaches → Java code → complexity) + study photos per
            problem, backed by Cloudflare R2.
          </p>
        </div>
      ...
      <section className="grid gap-4 md:grid-cols-3">
        ...
        <div className="rounded-xl border bg-card p-4">
          ...
          <div className="mt-1 text-sm text-muted-foreground">
            Prism highlighting with theme-aware code colors.
          </div>
        </div>
        <div className="rounded-xl border bg-card p-4">
