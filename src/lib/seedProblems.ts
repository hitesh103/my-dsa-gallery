  ...
  },
  {
    ...
    content: {
      ...
      optimal: {
        ...
        approachMd: "Scan once, maintaining the current jump range end.",
        visualization: {
          steps: [
            {
              label: "Initial State",
              description: "nums = [2, 3, 1, 1, 4]. Start at index 0.",
              nodes: [
                { id: "i0", type: "array", position: { x: 0, y: 0 }, data: { type: "array", index: 0, value: "2", highlight: "active" } },
                { id: "i1", type: "array", position: { x: 80, y: 0 }, data: { type: "array", index: 1, value: "3", highlight: "default" } },
                { id: "i2", type: "array", position: { x: 160, y: 0 }, data: { type: "array", index: 2, value: "1", highlight: "default" } },
                { id: "i3", type: "array", position: { x: 240, y: 0 }, data: { type: "array", index: 3, value: "1", highlight: "default" } },
                { id: "i4", type: "array", position: { x: 320, y: 0 }, data: { type: "array", index: 4, value: "4", highlight: "default" } },
              ],
              edges: [
                { id: "e-0-1", source: "i0", target: "i1", type: "straight", data: { type: "next" } },
                { id: "e-0-2", source: "i0", target: "i2", type: "straight", data: { type: "next" } },
              ],
            },
            {
              label: "Jump 1: Range [0, 2]",
              description: "currentEnd=0, farthest=2. Next jump can reach index 2.",
              nodes: [
                { id: "i0", type: "array", position: { x: 0, y: 0 }, data: { type: "array", index: 0, value: "2", highlight: "done" } },
                { id: "i1", type: "array", position: { x: 80, y: 0 }, data: { type: "array", index: 1, value: "3", highlight: "active" } },
                { id: "i2", type: "array", position: { x: 160, y: 0 }, data: { type: "array", index: 2, value: "1", highlight: "active" } },
                { id: "i3", type: "array", position: { x: 240, y: 0 }, data: { type: "array", index: 3, value: "1", highlight: "default" } },
                { id: "i4", type: "array", position: { x: 320, y: 0 }, data: { type: "array", index: 4, value: "4", highlight: "default" } },
              ],
              edges: [
                { id: "e-1-2", source: "i1", target: "i2", type: "straight", data: { type: "next" } },
                { id: "e-1-3", source: "i1", target: "i3", type: "straight", data: { type: "next" } },
                { id: "e-1-4", source: "i1", target: "i4", type: "straight", data: { type: "next" } },
                { id: "e-2-3", source: "i2", target: "i3", type: "straight", data: { type: "next" } },
              ],
            },
            {
              label: "Jump 2: Reach End!",
              description: "i == currentEnd (2==2). Take jump to farthest=4. Done!",
              nodes: [
                { id: "i0", type: "array", position: { x: 0, y: 0 }, data: { type: "array", index: 0, value: "2", highlight: "done" } },
                { id: "i1", type: "array", position: { x: 80, y: 0 }, data: { type: "array", index: 1, value: "3", highlight: "done" } },
                { id: "i2", type: "array", position: { x: 160, y: 0 }, data: { type: "array", index: 2, value: "1", highlight: "done" } },
                { id: "i3", type: "array", position: { x: 240, y: 0 }, data: { type: "array", index: 3, value: "1", highlight: "comparing" } },
                { id: "i4", type: "array", position: { x: 320, y: 0 }, data: { type: "array", index: 4, value: "4", highlight: "active" } },
              ],
              edges: [
                { id: "e-final", source: "i1", target: "i4", type: "straight", data: { type: "next", highlight: "active" } },
              ],
            },
          ],
        },
          ...
          steps: [
            {
              ...
              nodes: [
                { id: "00", type: "matrix", position: { x: 0, y: 0 }, data: { type: "matrix", row: 0, col: 0, value: "." } },
                { id: "01", type: "matrix", position: { x: 80, y: 0 }, data: { type: "matrix", row: 0, col: 1, value: "." } },
                { id: "02", type: "matrix", position: { x: 160, y: 0 }, data: { type: "matrix", row: 0, col: 2, value: "." } },
                { id: "03", type: "matrix", position: { x: 240, y: 0 }, data: { type: "matrix", row: 0, col: 3, value: "." } },
                { id: "10", type: "matrix", position: { x: 0, y: 80 }, data: { type: "matrix", row: 1, col: 0, value: "." } },
                { id: "11", type: "matrix", position: { x: 80, y: 80 }, data: { type: "matrix", row: 1, col: 1, value: "." } },
                { id: "12", type: "matrix", position: { x: 160, y: 80 }, data: { type: "matrix", row: 1, col: 2, value: "." } },
                { id: "13", type: "matrix", position: { x: 240, y: 80 }, data: { type: "matrix", row: 1, col: 3, value: "." } },
                { id: "20", type: "matrix", position: { x: 0, y: 160 }, data: { type: "matrix", row: 2, col: 0, value: "." } },
                { id: "21", type: "matrix", position: { x: 80, y: 160 }, data: { type: "matrix", row: 2, col: 1, value: "." } },
                { id: "22", type: "matrix", position: { x: 160, y: 160 }, data: { type: "matrix", row: 2, col: 2, value: "." } },
                { id: "23", type: "matrix", position: { x: 240, y: 160 }, data: { type: "matrix", row: 2, col: 3, value: "." } },
                { id: "30", type: "matrix", position: { x: 0, y: 240 }, data: { type: "matrix", row: 3, col: 0, value: "." } },
                { id: "31", type: "matrix", position: { x: 80, y: 240 }, data: { type: "matrix", row: 3, col: 1, value: "." } },
                { id: "32", type: "matrix", position: { x: 160, y: 240 }, data: { type: "matrix", row: 3, col: 2, value: "." } },
                { id: "33", type: "matrix", position: { x: 240, y: 240 }, data: { type: "matrix", row: 3, col: 3, value: "." } },
              ],
              edges: [],
            },
            {
              label: "Place Q at (0,1)",
              description: "Block column 1 and diagonals using hash sets",
              nodes: [
                { id: "00", type: "matrix", position: { x: 0, y: 0 }, data: { type: "matrix", row: 0, col: 0, value: "." } },
                { id: "01", type: "matrix", position: { x: 80, y: 0 }, data: { type: "matrix", row: 0, col: 1, value: "Q", highlight: "new" } },
                { id: "02", type: "matrix", position: { x: 160, y: 0 }, data: { type: "matrix", row: 0, col: 2, value: "." } },
                { id: "03", type: "matrix", position: { x: 240, y: 0 }, data: { type: "matrix", row: 0, col: 3, value: "." } },
                { id: "10", type: "matrix", position: { x: 0, y: 80 }, data: { type: "matrix", row: 1, col: 0, value: "." } },
                { id: "11", type: "matrix", position: { x: 80, y: 80 }, data: { type: "matrix", row: 1, col: 1, value: "X", highlight: "cell" } },
                { id: "12", type: "matrix", position: { x: 160, y: 80 }, data: { type: "matrix", row: 1, col: 2, value: "." } },
                { id: "13", type: "matrix", position: { x: 240, y: 80 }, data: { type: "matrix", row: 1, col: 3, value: "." } },
                { id: "20", type: "matrix", position: { x: 0, y: 160 }, data: { type: "matrix", row: 2, col: 0, value: "." } },
                { id: "21", type: "matrix", position: { x: 80, y: 160 }, data: { type: "matrix", row: 2, col: 1, value: "." } },
                { id: "22", type: "matrix", position: { x: 160, y: 160 }, data: { type: "matrix", row: 2, col: 2, value: "X", highlight: "cell" } },
                { id: "23", type: "matrix", position: { x: 240, y: 160 }, data: { type: "matrix", row: 2, col: 3, value: "." } },
                { id: "30", type: "matrix", position: { x: 0, y: 240 }, data: { type: "matrix", row: 3, col: 0, value: "." } },
                { id: "31", type: "matrix", position: { x: 80, y: 240 }, data: { type: "matrix", row: 3, col: 1, value: "." } },
                { id: "32", type: "matrix", position: { x: 160, y: 240 }, data: { type: "matrix", row: 3, col: 2, value: "." } },
                { id: "33", type: "matrix", position: { x: 240, y: 240 }, data: { type: "matrix", row: 3, col: 3, value: "X", highlight: "cell" } },
              ],
              edges: [
                { id: "e-c1", source: "01", target: "11", type: "straight", label: "col", data: { type: "edge", highlight: "active" } },
                { id: "e-d1", source: "01", target: "22", type: "straight", label: "diag", data: { type: "edge", highlight: "active" } },
                { id: "e-d2", source: "01", target: "33", type: "straight", label: "diag", data: { type: "edge", highlight: "active" } },
              ],
            },
            {
              label: "Place Q at (2,0)",
              description: "Row 2: only column 0 is safe",
              nodes: [
                { id: "00", type: "matrix", position: { x: 0, y: 0 }, data: { type: "matrix", row: 0, col: 0, value: "." } },
                { id: "01", type: "matrix", position: { x: 80, y: 0 }, data: { type: "matrix", row: 0, col: 1, value: "Q", highlight: "visited" } },
                { id: "02", type: "matrix", position: { x: 160, y: 0 }, data: { type: "matrix", row: 0, col: 2, value: "." } },
                { id: "03", type: "matrix", position: { x: 240, y: 0 }, data: { type: "matrix", row: 0, col: 3, value: "." } },
                { id: "10", type: "matrix", position: { x: 0, y: 80 }, data: { type: "matrix", row: 1, col: 0, value: "." } },
                { id: "11", type: "matrix", position: { x: 80, y: 80 }, data: { type: "matrix", row: 1, col: 1, value: "X", highlight: "cell" } },
                { id: "12", type: "matrix", position: { x: 160, y: 80 }, data: { type: "matrix", row: 1, col: 2, value: "." } },
                { id: "13", type: "matrix", position: { x: 240, y: 80 }, data: { type: "matrix", row: 1, col: 3, value: "." } },
                { id: "20", type: "matrix", position: { x: 0, y: 160 }, data: { type: "matrix", row: 2, col: 0, value: "Q", highlight: "new" } },
                { id: "21", type: "matrix", position: { x: 80, y: 160 }, data: { type: "matrix", row: 2, col: 1, value: "X", highlight: "cell" } },
                { id: "22", type: "matrix", position: { x: 160, y: 160 }, data: { type: "matrix", row: 2, col: 2, value: "X", highlight: "cell" } },
                { id: "23", type: "matrix", position: { x: 240, y: 160 }, data: { type: "matrix", row: 2, col: 3, value: "." } },
                { id: "30", type: "matrix", position: { x: 0, y: 240 }, data: { type: "matrix", row: 3, col: 0, value: "." } },
                { id: "31", type: "matrix", position: { x: 80, y: 240 }, data: { type: "matrix", row: 3, col: 1, value: "X", highlight: "cell" } },
                { id: "32", type: "matrix", position: { x: 160, y: 240 }, data: { type: "matrix", row: 3, col: 2, value: "." } },
                { id: "33", type: "matrix", position: { x: 240, y: 240 }, data: { type: "matrix", row: 3, col: 3, value: "X", highlight: "cell" } },
              ],
              edges: [
                { id: "e-c1", source: "01", target: "11", type: "straight", label: "col", data: { type: "edge", highlight: "visited" } },
                { id: "e-d1", source: "01", target: "22", type: "straight", label: "diag", data: { type: "edge", highlight: "visited" } },
                { id: "e-d2", source: "01", target: "33", type: "straight", label: "diag", data: { type: "edge", highlight: "visited" } },
                { id: "e-c2", source: "20", target: "31", type: "straight", label: "col", data: { type: "edge", highlight: "active" } },
                { id: "e-d3", source: "20", target: "11", type: "straight", label: "diag", data: { type: "edge", highlight: "active" } },
                { id: "e-d4", source: "20", target: "02", type: "straight", label: "diag", data: { type: "edge", highlight: "active" } },
              ],
            },
            {
              label: "Complete Solution",
              description: ".Q.. ...Q Q... ..Q. is one valid solution",
              nodes: [
                { id: "00", type: "matrix", position: { x: 0, y: 0 }, data: { type: "matrix", row: 0, col: 0, value: "." } },
                { id: "01", type: "matrix", position: { x: 80, y: 0 }, data: { type: "matrix", row: 0, col: 1, value: "Q", highlight: "visited" } },
                { id: "02", type: "matrix", position: { x: 160, y: 0 }, data: { type: "matrix", row: 0, col: 2, value: "." } },
                ...
                { id: "11", type: "matrix", position: { x: 80, y: 80 }, data: { type: "matrix", row: 1, col: 1, value: "X", highlight: "cell" } },
                { id: "12", type: "matrix", position: { x: 160, y: 80 }, data: { type: "matrix", row: 1, col: 2, value: "." } },
                { id: "13", type: "matrix", position: { x: 240, y: 80 }, data: { type: "matrix", row: 1, col: 3, value: "Q", highlight: "visited" } },
                { id: "20", type: "matrix", position: { x: 0, y: 160 }, data: { type: "matrix", row: 2, col: 0, value: "Q", highlight: "visited" } },
                { id: "21", type: "matrix", position: { x: 80, y: 160 }, data: { type: "matrix", row: 2, col: 1, value: "X", highlight: "cell" } },
                { id: "22", type: "matrix", position: { x: 160, y: 160 }, data: { type: "matrix", row: 2, col: 2, value: "." } },
                { id: "23", type: "matrix", position: { x: 240, y: 160 }, data: { type: "matrix", row: 2, col: 3, value: "X", highlight: "cell" } },
                { id: "30", type: "matrix", position: { x: 0, y: 240 }, data: { type: "matrix", row: 3, col: 0, value: "." } },
                { id: "31", type: "matrix", position: { x: 80, y: 240 }, data: { type: "matrix", row: 3, col: 1, value: "X", highlight: "cell" } },
                { id: "32", type: "matrix", position: { x: 160, y: 240 }, data: { type: "matrix", row: 3, col: 2, value: "Q", highlight: "visited" } },
                { id: "33", type: "matrix", position: { x: 240, y: 240 }, data: { type: "matrix", row: 3, col: 3, value: "X", highlight: "cell" } },
              ],
              edges: [
                { id: "e-q1", source: "01", target: "13", type: "straight", label: "same col?", data: { type: "edge", highlight: "path" } },
                { id: "e-q2", source: "01", target: "22", type: "straight", label: "diag?", data: { type: "edge", highlight: "path" } },
                { id: "e-q3", source: "01", target: "33", type: "straight", label: "diag?", data: { type: "edge", highlight: "path" } },
              ],
            },
          ],
        },
